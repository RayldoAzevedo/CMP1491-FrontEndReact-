...
class AddUserComponent extends Component {
    ...
    //     this.setState({ id: this.getQueryParams(this.props.location.search).get('id') });
    //     this.setState({ nome: this.getQueryParams(this.props.location.search).get('nome') });
    //     this.setState({ login: this.getQueryParams(this.props.location.search).get('login') });
    //     this.setState({ idade: this.getQueryParams(this.props.location.search).get('idade') });
    //     this.setState({ perfil: this.getQueryParams(this.props.location.search).get('perfil') });
    // }
    //montagem do componente
    componentDidMount() {
        //ao carregar a página mantem os valores da URL nos valores do state
    ...
    saveUser = (e) => {
        //TODO: obtemos dados do state e envia para o backend salvar os dados
        alert('Usuário Salvo!');
    }
        ...
        return(
            <div>
                ...
                <form>
                    ...
                    <div>
                        <label>Idade:</label>
                        < input type="text" name="idade" value={this.state.idade} onChange={this.onChange}/>
                    </div>
                    <div>
                        <label>Perfil:</label>
                        < input type="text" name="perfil" value={this.state.perfil} onChange={this.onChange}/>
                    </div>
                    <br></br>
